...
function [stim_dB_test,p_test,QUEST,resp] = Quest_main_de(send,trial_count,trial_num,threshold,stim_dB,QUEST,w_max,w_bl)
%% Main Code
...
if trial_num == 1
    ...
    percent_diff = 0.8;
    stim_test = percent_diff*(w_max-w_bl)+w_bl;
    ...
    prompt = sprintf('Do you notice a difference between A and B?\n');
    str = input(prompt,'s');
...
% Other Trials--------------------------------------------------------
    ...
    stim_test = 10^(stim_dB_test/20)*(w_max-w_bl)+w_bl;
